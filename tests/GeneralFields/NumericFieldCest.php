...
//            $requiredMessage,
        ...
        $I->seeElement("//input", ['min' => $minValue], $I->cmnt('Check numericField min value'));
        $I->seeElement("//input", ['max' => $maxValue], $I->cmnt('Check numericField max value'));
        $I->seeElement("//input", ['step' => 'any'], $I->cmnt('Check numericField step value'));

        echo $I->cmnt("All test cases went through. ", 'yellow','',array('blink'));

        // checking error message remaining, because of the bug in the plugin
    }
    public function test_numeric_field_with_calculation(AcceptanceTester $I)
    {
        $pageName = __FUNCTION__ . '_' . rand(1, 100);
        $faker = \Faker\Factory::create();
