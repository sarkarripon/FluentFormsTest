...
trait AcceptanceTesterActions
{
     ...
     * [!] Method is generated.
     * 
     * * Executes loadDotEnvFile and retries on failure.
     * 
    ...
    public function retryLoadDotEnvFile() {
        ...
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('loadDotEnvFile', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes loginWordpress and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::loginWordpress()
    ...
    public function retryLoginWordpress(?string $username = NULL, ?string $password = NULL) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('loginWordpress', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes restartSession and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::restartSession()
    ...
    public function retryRestartSession() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('restartSession', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes cleanCookies and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::cleanCookies()
    ...
    public function retryCleanCookies() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('cleanCookies', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes wpLogout and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::wpLogout()
    ...
    public function retryWpLogout() {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('wpLogout', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes filledField and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::filledField()
    ...
    public function retryFilledField($selector, $value) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('filledField', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes clicked and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::clicked()
    ...
    public function retryClicked(string $selector) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('clicked', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes clickedOnText and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::clickedOnText()
     ...
     * [!] Method is generated.
     * 
     * * Executes clickOnExactText and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::clickOnExactText()
     ...
     * [!] Method is generated.
     * 
     * * Executes clickByJS and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::clickByJS()
    ...
    public function retryClickByJS(string $selector) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('clickByJS', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes fillByJS and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::fillByJS()
     ...
     * [!] Method is generated.
     * 
     * * Executes seeTextCaseInsensitive and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::seeTextCaseInsensitive()
     ...
     * [!] Method is generated.
     * 
     * * Executes checkElement and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::checkElement()
    ...
    public function retryCheckElement($element) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('checkElement', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes assertString and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::assertString()
    ...
    public function retryAssertString(array $checkAbleArr) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('assertString', func_get_args(), $retryNum, $retryInterval));
    }
     ...
     * [!] Method is generated.
     * 
     * * Executes checkValuesInArray and retries on failure.
     * 
     * Retry number and interval set by $I->retry();
     *
     * @see \Tests\Support\Helper\AcceptanceHelper::checkValuesInArray()
    ...
    public function retryCheckValuesInArray(array $dataArray, $searchStrings) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
        return $this->getScenario()->runStep(new \Codeception\Step\Retry('checkValuesInArray', func_get_args(), $retryNum, $retryInterval));
    }
